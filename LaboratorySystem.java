public class LaboratorySystem {
    ...
    private void updateReportStatus(){
        ...
        int patientIdToUpdate = In.nextInt();
    ...
    private boolean confirm() {
        System.out.print("Are you sure thatyou want to exit (y/n)?: ");
    ...
    private void help() {
        ...
        System.out.println("C- This option allows you to dd a new doctor to the system. Enter ID, name, emergency contact, and specialization details.");
